...
| 항목 | 링크 |
|---|---|
| 배포 서비스 | [https://anjonghwa.madcamp-kaist.org](https://anjonghwa.madcamp-kaist.org) |
| GitHub Repository | [https://github.com/madcamp-official/26s-w1-c1-05](https://github.com/madcamp-official/26s-w1-c1-05) |
| 발표 시연 스크립트 | [docs/DEMO_PRESENTATION_SCRIPT.md](docs/DEMO_PRESENTATION_SCRIPT.md) |
| 제출 체크리스트 | [docs/submission/WEEK1_SUBMISSION_CHECKLIST.md](docs/submission/WEEK1_SUBMISSION_CHECKLIST.md) |
...
| Database | MySQL |
| Auth | JWT, BCrypt |
| AI | Gemini API, local fallback prompt generator |
| Deploy | KCloud VM, madcamp-kaist.org subdomain |

## Demo Screens

GitHub 제출 기준의 이미지 산출물로 5개 화면 캡처를 포함합니다.
...
발표용 baseline DB 기준 계정입니다. 모든 계정의 비밀번호는 `password`입니다.

| 사용자 | 이메일 |
|---|---|
| 김희서 | `heeseo.team5.20260708113041@example.com` |
| 안종화 | `anjonghwa.team5.20260708113041@example.com` |
| 클로드 | `claude.team5.20260708113041@example.com` |
| 코덱스 | `codex.team5.20260708113041@example.com` |
| 제미나이 | `gemini.team5.20260708113041@example.com` |
| 이광형 | `kwanghyung.team5.20260708113041@example.com` |

| 팀 | 접속 정보 | 시연 목적 |
|---|---|---|
| Team A - Scrum Helper Release | 초대코드 `5QZ2B4T6` | 완료된 프로젝트, Wrap-up, 회고 |
| Team B - Scrum Helper Sprint 2 | 비밀번호 `team1234` | 진행 중 프로젝트, Todo, Task 보드 |

## APK

이 프로젝트는 웹 기반 서비스이므로 APK 파일은 없습니다. 제출 산출물은 배포 URL과 GitHub Repository로 대체합니다.
